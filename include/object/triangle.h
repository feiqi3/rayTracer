...
public:
  ...
  virtual void set_texcoord(const vec3 &_sp1, const vec3 &_sp2,
                            const vec3 &_sp3) {
    s_p1 = _sp1;
    s_p2 = _sp2;
    s_p3 = _sp3;
...
protected:
  ...
  and wil be used when be use
  in function is_in_tri
  */
  vec3 _v0, _v1;
...
inline void triangle::__recaculate() {
  _v0 = p3 - p1;
  _v1 = p2 - p1;
  _dot00 = dot(_v0, _v0);
  _dot01 = dot(_v0, _v1);
  ...
  normal = normalize(cross(_v1, p3 - p2));
  area = get_triangle_size(p1, p2, p3);
  Flog::flog(TRACE, "Recaculate,"+toString());
}

inline triangle::triangle(const vec3 &_p1, const vec3 &_p2, const vec3 &_p3)
    : p1(_p1), p2(_p2), p3(_p3), s_p1(p1), s_p2(p2), s_p3(p3) {
  _v0 = p3 - p1;
  _v1 = p2 - p1;
  _dot00 = dot(_v0, _v0);
  _dot01 = dot(_v0, _v1);
...
inline void triangle::transform(const mat4 &mat) {
